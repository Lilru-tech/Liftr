...
-- Cuerpos de función con comillas simples: AS ' ... ' (cada ' interna en SQL va como '').
-- Pensado para DbVisualizer u otros clientes que fallan con dollar-quoting ($$).
-- Véase también: achievements_extra_sports_deploy.sql (misma lógica, cuerpos con $$).
-- =============================================================================
BEGIN;
...
-- Variante para clientes que no aceptan dollar-quoting ($$): cuerpo entre AS ' ... '
-- con comillas simples duplicadas ('') en el interior. Ejecutar cada CREATE de una vez.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3) Orquestador (un bloque entero hasta el cierre '; tras el final del cuerpo ')
-- ---------------------------------------------------------------------------
