-- Hotfix for deployments that applied an earlier 20260417210100 revision where `workouts`
-- policies subqueried `workouts`, causing 42P17 infinite recursion (Home / Profile empty).
-- Safe to run on top of the corrected 20260417210100 (idempotent).
