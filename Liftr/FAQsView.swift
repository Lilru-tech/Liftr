...
struct FAQsView: View {
    ...
    private var faqsBySection: [String: [FAQ]] {
        let faqs: [FAQ] = [
            ...
            FAQ(
                question: "What is Wearable routes?",
                answer: "In Profile → Settings → Wearable routes you can connect your Garmin Connect account to backfill missing GPS routes for cardio workouts imported from Apple Health, so your runs and rides show their route on the map.",
                category: "Apple Health Import (Cardio)"
            ),
            FAQ(
            ...
            FAQ(
                ...
                answer: "You can update personal info, contact support, open FAQs, import cardio from Apple Health, connect wearable routes, restore purchases, sign out, or permanently delete your account.",
