...
alter table public.exercise_sets disable trigger user;
...
alter table public.exercise_sets enable trigger user;
...
alter table public.workout_exercises disable trigger user;
...
alter table public.workout_exercises enable trigger user;
