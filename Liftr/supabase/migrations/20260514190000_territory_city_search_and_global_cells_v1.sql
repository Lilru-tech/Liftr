create index if not exists territory_municipalities_display_name_lower_idx
  on public.territory_municipalities (lower(display_name));
...
create or replace function public.get_territory_total_cells_leaderboard_v1 (
  p_scope text,
...
grant execute on function public.get_territory_total_cells_leaderboard_v1 (text, integer) to authenticated;
