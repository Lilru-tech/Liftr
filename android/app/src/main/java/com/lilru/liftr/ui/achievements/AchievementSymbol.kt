...
/** Paridad con iOS [symbolForAchievement] (subset de iconos Material). */
fun imageVectorForAchievement(code: String, category: String): ImageVector {
    ...
    return when {
        ...
        c.startsWith("hyrox_") -> Icons.Filled.Timer
        c.startsWith("cardio_") || c.startsWith("duration_") || c.startsWith("elev_gain_") -> Icons.Filled.Bolt
        c.startsWith("padel_") || c.startsWith("tennis_") || c.startsWith("table_tennis_") || c.startsWith("squash_") ||
            c.startsWith("badminton_") -> Icons.Filled.Sports
        ...
        c.startsWith("ranking_") -> Icons.Filled.Star
